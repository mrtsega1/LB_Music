...
OWNER_ID = int(getenv("OWNER_ID", "5501294143"))
...
START_IMG_URL = getenv(
    "START_IMG_URL", "https://graph.org/file/499890a267eb5143a4144.jpg"
)
PING_IMG_URL = getenv(
    "PING_IMG_URL", "https://graph.org/file/a1e6150a1f4019242a22a.jpg"
)
